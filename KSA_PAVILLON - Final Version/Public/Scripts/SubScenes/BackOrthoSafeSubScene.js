...
//materialDiscover = script.imageDiscover.mainMaterial;
...
{
    global.materialDiscover.mainPass.baseColor = new vec4(1,1,1,ratio);
}
...
{
    revealed = false;
    StopVideo(global.videoSaudiControl);
    global.materialDiscover.mainPass.baseColor = new vec4(1,1,1,0);
}
...
function OnUserTapped()
{
    ...
    {
        revealed = true;
        global.materialDiscover.mainPass.baseColor = new vec4(1,1,1,1);
        PlayVideo(global.videoSaudiControl, 1);
